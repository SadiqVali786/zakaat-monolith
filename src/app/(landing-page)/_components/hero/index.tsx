...
export const Hero = () => {
  return (
    <SectionTemplate
      ...
      headingPart2="Support the Deserving Zakaat Applicants"
      infoLine="Fulfill your duty of Zakat with purpose, backed by the power of Artificial Intelligence. Our platform ensures your contributions reach truly deserving Applicants by safeguarding against fraudulent applications. Connect with those genuinely in need."
